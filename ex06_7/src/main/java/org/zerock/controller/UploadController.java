...
//		String uploadFolder = "/home/eprot/upload";
		...
		for(MultipartFile multipartFile : uploadFile) {
			...
			try {
				...
				//System.out.println("attachDTO UUID : " + uuid.toString());
...
//		File file = new File("/home/eprot/upload/"+fileName);
		log.info("file : " + file);
...
//		FileSystemResource resource = new FileSystemResource("/home/eprot/upload/"+fileName);
...
//	@GetMapping(value="/download", produces=MediaType.APPLICATION_OCTET_STREAM_VALUE)
//	@ResponseBody
//	public ResponseEntity<FileSystemResource> downloadFile(@RequestHeader("User-Agent") String userAgent, String fileName){
//		log.info("download file : " +fileName);
//		FileSystemResource resource = new FileSystemResource("c:\\upload\\"+fileName);
//		FileSystemResource resource = new FileSystemResource("/home/eprot/upload/"+fileName);	
