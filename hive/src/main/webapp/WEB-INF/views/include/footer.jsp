<%@ page language="java" contentType="text/html; charset=UTF-8"
  ...
  <script src="${ctxpath}/resources/vendor/jquery/jquery-3.2.1.min.js"></script>
  ...
  <script src="${ctxpath}/resources/js/sb-admin-2.min.js"></script>
  ...
  <script src="${ctxpath}/resources/js/demo/chart-pie-demo.js"></script>
	<script>
